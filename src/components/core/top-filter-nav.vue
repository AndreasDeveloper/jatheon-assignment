<template>
  <div class="top-filter-nav-wrap">
    <div class="filter-elements">
      <form>
        <jtSelect class="form-el" :list="users" :dropName="'dropdown'" :showSearch="true" :disableD2="false" @emitChecked="checkFilters" />
        <jtSelect class="form-el" :list="actions" :dropName="'dropdown2'" :showSearch="false" :disableD2="disableD2" />
